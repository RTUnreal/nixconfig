  ...
  python = python311.override {
    packageOverrides = self: super: {
      inflate64 = self.callPackage
        ...
        { };
      multivolumefile = self.callPackage
        (
          { buildPythonPackage
          , fetchPypi
          }:
