{
  ...
  services.factorio = {
    ...
    in
      builtins.attrValues {
        inherit (mods) bobinserters BottleneckLite even-distribution far-reach Fill4Me playtime RateCalculator show-max-underground-distance some-squeak-through some-zoom;
      };
  };
